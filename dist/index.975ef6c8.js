...
const main = ()=>{
    _dataBusiness.apiExtraction(_dataBusiness.CHARACTER_ENDPOINT_URL).then(_dataBusiness.getCharacterPages).catch((reject)=>console.error("Error while extracting character pages (main) => " + reject)).then(_dataBusiness.buildCharacterList).catch((reject)=>console.error("Error while building character list (main) => " + reject));
};
window.onload = main;

},{"./data-business":"iM7Bx","./styles.css":"lW6qc"}],"iM7Bx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CHARACTER_ENDPOINT_URL", ()=>CHARACTER_ENDPOINT_URL);
parcelHelpers.export(exports, "apiExtraction", ()=>apiExtraction);
parcelHelpers.export(exports, "getCharacterPages", ()=>getCharacterPages);
parcelHelpers.export(exports, "buildCharacterList", ()=>buildCharacterList);
parcelHelpers.export(exports, "getCharacterOriginData", ()=>getCharacterOriginData);
parcelHelpers.export(exports, "getCharacterFirstLastEpisodesData", ()=>getCharacterFirstLastEpisodesData);
...
const getCharacterPages = (response)=>{
    ...
    for(let characterPage = 1; characterPage <= response.info.pages; characterPage++)characterPages.push(apiExtraction(new URL(CHARACTER_ENDPOINT_URL.href + "?page=" + characterPage)));
    return characterPages;
};
const buildCharacterList = (pages)=>{
    document.getElementById("root").replaceChildren();
    for (const page of pages)page.then((charactersPage)=>{
        for (const character of charactersPage.results){
            const characterElement = _utils.createCharacterRow(character);
            characterElement.addEventListener("click", ()=>{
                _utils.showCharacter(character);
            });
...
const getCharacterOriginData = (character)=>{
    if (character.origin.url.length !== 0) return apiExtraction(new URL(character.origin.url)).then((originData)=>{
...
const getCharacterFirstLastEpisodesData = (character)=>{
    ...
    return apiExtraction(new URL(EPISODE_ENDPOINT_URL.href + "/" + characterFirstLastEpisodeId)).then((episodesData)=>{
        character.episodes = new Array();
        for (const episodeData of episodesData)character.episodes.push({
            episode: episodeData.episode,
            name: episodeData.name
        });
        if (character.episode.length === 1) character.episodes.push(character.episodes[0]);
        return character;
...
},{"./utils":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"en4he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const showCharacter = (character)=>{
    ...
    _dataBusiness.getCharacterOriginData(character).then(_dataBusiness.getCharacterFirstLastEpisodesData).catch((reject)=>console.error("Error while extracting character first-last episode data (showCharacter) => " + reject)).then((character)=>{
...
},{"./data-business":"iM7Bx","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"7Rzro":[function(require,module,exports) {
...
},{}],"lW6qc":[function() {},{}]},["62qGc","8lqZg"], "8lqZg", "parcelRequire847c")
